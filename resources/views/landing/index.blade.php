...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Pelaporan Masyarakat</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h1>KOTA BOGOR</h1>
          <h2>Laporkan pengaduan kepihak berwajib</h2>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        <h6>- Buat akun terlebih dahulu jika belum meniliki akun</h6>
        <h6>- Lalu Login, mauskan username dan password anda</h6>
        <h6>- </h6>
        <h6>- </h6>
      </div>
    </div>
